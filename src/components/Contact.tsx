    ...
    <section id="contact" className="py-24 md:py-32 px-6 md:px-20">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 px-7 py-4 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-xl text-white font-semibold hover:-translate-y-0.5 hover:shadow-[0_12px_40px_rgba(99,102,241,0.4)] transition-all duration-300"
          >
            <Send size={16} />
            Send Message
          </button>
