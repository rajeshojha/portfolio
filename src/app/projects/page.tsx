    ...
    <main className="min-h-screen bg-[#0a0a0b] text-white">
      ...
      <section className="pt-32 pb-16 px-6 md:px-20">
        ...
        >
          ...
          <h1 className="font-['Space_Grotesk',sans-serif] text-4xl md:text-5xl font-bold tracking-tight">
            All Projects
          </h1>
          <p className="text-[var(--color-secondary)] mt-4 max-w-2xl">
            A collection of projects spanning full-stack development, AI/ML
            platforms, quality engineering, and test automation.
          </p>
        </motion.div>
      </section>
